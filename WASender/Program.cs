...
builder.Services.AddCors(options =>
{
    options.AddPolicy("AllowAll", builder =>
    {
        builder.WithOrigins("https://yourdomain.com", "https://localhost:5001")
               .AllowCredentials()
               .AllowAnyMethod()
               .AllowAnyHeader();
    });
...
// 🔹 Add "page-settings" Authorization Policy
builder.Services.AddAuthorization(options =>
{
    options.AddPolicy("page-settings", policy =>
    {
        policy.RequireAuthenticatedUser();
        // Optional: policy.RequireRole("Admin"); if needed
    });
});
